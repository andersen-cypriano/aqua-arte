				...
				{% block input_prepend_content %}
					<div class="col-12 mb-2 form-label">
						...
						<span class="align-middle">
								...
								<span class="{% if free_shipping_minimum_label_changes_visibility %}js-shipping-calculator-label-default{% endif %}" {% if (product_detail and free_shipping_messages_visible) or (cart.free_shipping.min_price_free_shipping.min_price_raw == 0 and has_free_shipping) %}style="display: none;"{% endif %}>
